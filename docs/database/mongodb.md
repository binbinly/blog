...
![WiredTiger B+树整体结构](../images/mongodb/mongodb-b-plus-tree-integral-structure.png)
...
![管道的工作流程](../images/mongodb/mongodb-aggregation-stage.png)
...
![复合索引](../images/mongodb/mongodb-composite-index.png)
...
![](../images/mongodb/replica-set-read-write-operations-primary.png)
...
![](../images/mongodb/replica-set-primary-with-two-secondaries.png)
...
![](../images/mongodb/sharded-cluster-production-architecture.png)
...
![](../images/mongodb/example-of-scope-based-sharding.png)
...
![](../images/mongodb/example-of-hash-based-sharding.png)
...
![Chunk 分裂](../images/mongodb/chunk-splitting-shard-a.png)
...
![Chunk 迁移](../images/mongodb/mongo-reblance-three-shards.png)
