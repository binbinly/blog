...
![WiredTiger B+树整体结构](static/images/mongodb/mongodb-b-plus-tree-integral-structure.png)
...
![管道的工作流程](static/images/mongodb/mongodb-aggregation-stage.png)
...
![复合索引](static/images/mongodb/mongodb-composite-index.png)
...
![](static/images/mongodb/replica-set-read-write-operations-primary.png)
...
![](static/images/mongodb/replica-set-primary-with-two-secondaries.png)
...
![](static/images/mongodb/sharded-cluster-production-architecture.png)
...
![](static/images/mongodb/example-of-scope-based-sharding.png)
...
![](static/images/mongodb/example-of-hash-based-sharding.png)
...
![Chunk 分裂](static/images/mongodb/chunk-splitting-shard-a.png)
...
![Chunk 迁移](static/images/mongodb/mongo-reblance-three-shards.png)
