...
> [原文](https://github.com/Snailclimb/JavaGuide/blob/main/docs/database/mysql/mysql-logs.md)
...
- my.cnf 中 log-error=[path]
- 启动时配置 mysqld_safe –user=mysql –log-error=[path] &
