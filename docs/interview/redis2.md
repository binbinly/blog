...
>[原文](https://github.com/Snailclimb/JavaGuide/blob/main/docs/database/redis/redis-questions-02.md)
...
![](static/images/redis/redis-pipeline-vs-transaction.png)
...
![bigkey 判定标准](static/images/redis/bigkey-criterion.png)
...
![缓存穿透](static/images/redis/redis-cache-penetration.png)
...
![加入布隆过滤器之后的缓存处理流程图](static/images/redis/redis-cache-penetration-bloom-filter.png)
...
![缓存击穿](static/images/redis/redis-cache-breakdown.png)
...
![缓存雪崩](static/images/redis/redis-cache-avalanche.png)
