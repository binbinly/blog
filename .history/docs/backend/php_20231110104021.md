...
| 函数名 | 描述 |
| --- | --- |
| [crypt](https://www.php.net/vfprintf) | 单向加密 |
| [str_rot13](https://www.php.net/vfprintf) | 对字符串执行 `ROT13` 编码 |
| [convert_uudecode](https://www.php.net/vfprintf) | 对 `uuencode` 编码的字符串进行解码 |
| [convert_uuencode](https://www.php.net/vfprintf) | 使用 `uuencode` 算法对字符串进行编码 |
| [quoted_printable_decode](https://www.php.net/vfprintf) | 把 `quoted-printable` 字符串解码为 8 位 `ASCII` 字符串 |
| [quoted_printable_encode](https://www.php.net/vfprintf) | 把 8 位字符串转换为 `quoted-printable` 字符串 |
| [bin2hex](https://www.php.net/vfprintf) | 将二进制数据转换成十六进制表示 |
| [hex2bin](https://www.php.net/vfprintf) | 把十六进制值转换为 `ASCII` 字符 |
